...
set [ find default-name=wlan1 ] band=5ghz-onlyn channel-width=10mhz disabled=\
    no frequency=5900 frequency-mode=superchannel l2mtu=2290 mode=ap-bridge \
    name=wlan1-gateway nv2-cell-radius=100 radio-name=KM4ECM/SEC2.SCO \
    scan-list=5900 ssid=HamWAN tdma-period-size=4 wireless-protocol=nv2
...
/ip pool
add name=hamwan ranges=44.34.128.66-44.34.128.78
/ip dhcp-server
remove [find]
...
set [ find default=yes ] in-filter=Ham-default out-filter=Ham-default \
    ...
    redistribute-other-ospf=as-type-1 router-id=44.34.128.35
/snmp community
set [ find default=yes ] addresses=44.34.128.0/21 name=hamwan
/ip address
remove [find]
add address=44.34.128.35/28 interface=ether1-local network=44.34.128.32
add address=44.34.128.65/28 interface=wlan1-gateway network=44.34.128.64
/ip dhcp-client
remove [find]
/ip dhcp-server network
add address=44.34.128.64/28 dns-server=44.34.132.1,44.34.133.1 domain=\
    memhamwan.net gateway=44.34.128.65 ntp-server=44.34.132.3,44.34.133.3
/ip dns
...
add area=backbone network=44.34.128.64/28
/snmp
