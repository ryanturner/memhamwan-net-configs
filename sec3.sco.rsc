...
set [ find default-name=wlan1 ] band=5ghz-onlyn channel-width=10mhz disabled=\
    no frequency=5880 frequency-mode=superchannel l2mtu=2290 mode=ap-bridge \
    name=wlan1-gateway nv2-cell-radius=100 radio-name=KM4ECM/SEC3.SCO \
    scan-list=5880 ssid=HamWAN tdma-period-size=4 wireless-protocol=nv2
...
set [ find default=yes ] in-filter=Ham-default out-filter=Ham-default \
    ...
    redistribute-other-ospf=as-type-1 router-id=44.34.128.36
/snmp community
